...
<div class="container text-center">
  ...
  <form class="mt-5" method="POST" action="{{route("plant.store")}}">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="plant-name" name="name">
    </div>
    <div class="mb-3">
        <label for="species" class="form-label">specie pianta:</label>
        <input type="text" class="form-control" id="plant-species" name="species">
      </div>
      <div class="mb-3">
        <label for="habitat" class="form-label">habitat pianta:</label>
        <input type="text" class="form-control" id="plant-habitat" name="habitat">
      </div>
      <div class="mb-3">
        <label for="exposure" class="form-label">esposizione pianta:</label>
        <input type="text" class="form-control" id="plant-exposure" name="exposure">
      </div>
      <div class="mb-3">
        <label for="description" class="form-label">descrizione pianta:</label>
        <input type="text" class="form-control" id="plant-description" name="description">
      </div>
      <div class="mb-3">
        <label for="image" class="form-label">immagine pianta:</label>
        <input type="text" class="form-control" id="plant-image" name="image">
      </div>
      <div class="buttons">
